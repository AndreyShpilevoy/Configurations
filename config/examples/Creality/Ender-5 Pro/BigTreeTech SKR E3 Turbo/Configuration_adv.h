 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 60        // Seconds    //kto old 40
  #define THERMAL_PROTECTION_HYSTERESIS 6     // Degrees Celsius   //kto old 4
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  40               // Seconds //kto default 20
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        40 // Seconds //kto 180 default 20
  #define THERMAL_PROTECTION_BED_HYSTERESIS     2 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                60 // Seconds //kto 180
 ...
 */
#define AUTOTEMP // kto disable if strange leak
#if ENABLED(AUTOTEMP)
 ...
 */
#define HOTEND_IDLE_TIMEOUT //kto
#if ENABLED(HOTEND_IDLE_TIMEOUT)
  #define HOTEND_IDLE_TIMEOUT_SEC (10*60)     //kto //(10*60) (seconds) Time without extruder movement to trigger protection
...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
  #define Z_STEPPER_ALIGN_XY { {  5, 185 }, { 5,  40 }, { 220, 112 } }
...
#define ENCODER_RATE_MULTIPLIER
  ...
  #define ENCODER_10X_STEPS_PER_SEC   30 //kto tft sensor 50 // (steps/s) Encoder rate for 10x speed
  #define ENCODER_100X_STEPS_PER_SEC  80 //kto tft sensor 800 // (steps/s) Encoder rate for 100x speed
#endif
...
#define LIN_ADVANCE
  ...
  #define EXPERIMENTAL_SCURVE //kto TODO experimental // Enable this option to permit S-Curve Acceleration
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       800//580        // (mA) RMS current. Multiply by 1.414 for peak current.
